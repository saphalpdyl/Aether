...
- **CoA/DM Daemon** — Go-based RADIUS Change-of-Authorization and Disconnect-Message daemon running alongside the BNG. Communicates with the Python event loop over Unix socket IPC. Enables the OSS to dynamically disconnect subscribers or change policies in real time.
