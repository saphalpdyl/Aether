...
import { DataTable } from "./data-table-events";
import { sessionEventSchema, type SessionEvent } from "./events-schema";

export default function SessionsEventsTable() {
  ...
  React.useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        console.log("[Events] Received:", json);
